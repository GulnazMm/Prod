...
public class ProductTest {
    ...
    public void searchByWord1() {
        ...
        Product[] actual = manager.searchBy("кин");
        Product[] expected = {book1, book2};
        Assertions.assertArrayEquals(expected, actual);
    ...
    public void searchByWord2() {
        ...
        Product[] actual = manager.searchBy("Книжка");
